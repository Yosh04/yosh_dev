...
export function Home() {
  ...
  return (
    <div id="home" className="bg-[#323234] h-full  w-full mt-16 md:mt-32 flex flex-col justify-center px-4 md:px-8 py-8 md:py-16">
      <section className="flex flex-col-reverse justify-around items-center md:flex-row md:justify-between lg:justify-evenly   md:items-center">
        <div className="text-white text-center md:text-left mt-12  md:mb-0">
          ...
          <p className="text-[#A59A9A] font-itim text-md w-full mt-4 md:w-[400px] lg:w-[700px] md:text-base  md:ml-[30px] lg:text-[16px]">
        ...
        <div className="bg-[url('https://res.cloudinary.com/du4xrfwcc/image/upload/v1715553307/UserProfile_e4rplm.png')] bg-contain bg-no-repeat bg-center self-center w-[200px] h-[200px] border-2 border-blue-500 rounded-full animate-morph shadow-[0_0_20px_#05F9F6,0_0_40px_#05F9F6,0_0_60px_#05F9F6,0_0_80px_#05F9F6] mt-8 md:mt-0">
        </div>
      </section>
    </div>
  );
